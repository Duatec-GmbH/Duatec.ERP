...
{
	[HtmlTargetElement("wv-field-file-multiple-no-limits")]
	public class WvFieldFileMultipleNoLimits : WvFieldBase
	{
		...
		public override Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
		{
			...
			output.AddCssClass("wv-field-file-multiple");
			...
			if (Mode == WvFieldRenderMode.Form)
			{
				if (Access == WvFieldAccess.Full || Access == WvFieldAccess.FullAndCreate)
				{
					...
					#region << Init Scripts >>
					{
						...
						var fileName = "form";
						if (ViewContext.HttpContext.Items.ContainsKey(typeof(WvFieldFileMultipleNoLimits) + fileName))
						{
							var tagHelperContext = (WvTagHelperContext)ViewContext.HttpContext.Items[typeof(WvFieldFileMultipleNoLimits) + fileName];
							tagHelperInitialized = tagHelperContext.Initialized;
						}
						if (!tagHelperInitialized)
						{
							var scriptContent = WvHelpers.GetEmbeddedTextResource("form.js", "WebVella.Erp.Web.TagHelpers.WvFieldFileMultipleNoLimits", "WebVella.Erp.Web");
							...
							ViewContext.HttpContext.Items[typeof(WvFieldFileMultipleNoLimits) + fileName] = new WvTagHelperContext()
							{
								Initialized = true
							};
