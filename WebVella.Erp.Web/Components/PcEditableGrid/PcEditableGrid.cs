...
{
	[PageComponent(Label = "Editable Grid", Library = "WebVella", Description = "Displays data list in a table format which is editable", Version = "0.1.2", IconClass = "fas fa-table")]
