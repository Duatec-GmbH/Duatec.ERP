...
{
	[PageComponent(Label = "Editable Grid", Library = "WebVella", Description = "Displays data list in a table format which is editable", Version = "0.1.1", IconClass = "fas fa-table")]
