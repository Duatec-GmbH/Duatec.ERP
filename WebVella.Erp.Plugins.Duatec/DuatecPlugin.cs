...
{
    internal class DuatecPlugin : ErpPlugin
    {
        ...
        private void ProcessPatches()
        {
            using (SecurityContext.OpenSystemScope())
            {
                ...
                #region << ***Create field***  Entity: manufacturer Field Name: eplan_id >>
                {
                    ...
                    numberField.Id = new Guid("f9d51408-c93c-4cf6-96e9-95d95773afd8");
                    numberField.Name = "eplan_id";
                    numberField.Label = "Eplan ID";
                    numberField.PlaceholderText = "e.g. 933976";
                    ...
                    //UPDATE
                    {
                        var response = entMan.CreateField(new Guid("95a2ecf6-5763-47b7-947c-28bd6554370e"), numberField, false);
                        if (!response.Success)
                ...
                {
                    InputTextField textboxField = new InputTextField();
                    textboxField.Id = new Guid("cdcbf987-a47b-40d5-9f77-7013928afa1c");
                ...
                {
                    InputNumberField numberField = new InputNumberField();
                    numberField.Id = new Guid("ac259a1e-9432-4656-a6c0-17994b7890c8");
                    numberField.Name = "eplan_id";
                    numberField.Label = "Eplan ID";
                    ...
                    //UPDATE
                    {
                        var response = entMan.CreateField(new Guid("14640617-3a63-4065-b96a-8ae586e5b68b"), numberField, false);
                        if (!response.Success)
                ...
                #region << ***Create field***  Entity: article Field Name: price >>
                {
                    InputCurrencyField currencyField = new InputCurrencyField();
                    currencyField.Id = new Guid("8da0e118-1d48-4f07-8278-b62667f73139");
                    currencyField.Name = "price";
                    currencyField.Label = "Price";
                    currencyField.PlaceholderText = null;
                    currencyField.Description = null;
                    currencyField.HelpText = null;
                    currencyField.Required = false;
                    currencyField.Unique = false;
                    currencyField.Searchable = false;
                    currencyField.Auditable = false;
                    currencyField.System = false;
                    currencyField.DefaultValue = null;
                    currencyField.MinValue = null;
                    currencyField.MaxValue = null;
                    currencyField.Currency = WebVella.Erp.Utilities.Helpers.GetCurrencyType("EUR");
                    currencyField.EnableSecurity = false;
                    ...
                    //UPDATE
                    {
                        var response = entMan.CreateField(new Guid("14640617-3a63-4065-b96a-8ae586e5b68b"), currencyField, false);
                        if (!response.Success)
                            throw new Exception("System error 10060. Entity: article Field: price Message:" + response.Message);
                    }
                }
                #endregion
                ...
                #region << ***Create app*** App name: Lager >>
                {
                ...
                #region << ***Create sitemap area*** Sitemap area name: Lager >>
                {
                ...
                #region << ***Create page body node*** Page name: article_list  id: c7d59ef4-6033-40d4-ac17-f9e0b44be529 >>
                {
                ...
                #region << ***Create page body node*** Page name: article_list  id: 9569b249-9a35-44b2-9d71-1e8c0d60b662 >>
                {
  ...
  ""container12_horizontal_align"": ""1""
                ...
                #region << ***Create page body node*** Page name: article_list  id: 81b3194d-137e-45ad-bf33-171808ca7d68 >>
                {
  ...
  ""label_help_text"": """"
                ...
                #region << ***Create page body node*** Page name: article_list  id: 442fa321-20be-4a58-b69c-d7b35bf01636 >>
                {
  ...
  ""label_help_text"": """"
                ...
                #region << ***Create page body node*** Page name: article_list  id: d1cd7593-6f32-4deb-bfd4-c2c8b3bdd97c >>
                {
  ...
  ""label_help_text"": """"
                ...
                #region << ***Create page body node*** Page name: article_list  id: 778f3b63-0da5-482b-a241-a3c63ce268e3 >>
                {
