...
namespace WebVella.Erp.Plugins.Duatec.Validators
{
    ...
    public class ArticleValidator : IRecordValidator<Article>
    {
        ...
        private static readonly NameFormatValidator _typeNumberValidator = new(Fields.TypeNumber, true);
        private static readonly NameFormatValidator _orderNumberValidator = new(Fields.OrderNumber, true);
        private static readonly NameFormatValidator _designationValidator = new(Fields.Designation, true);
